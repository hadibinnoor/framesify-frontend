            ...
            <div className=" bg-white p-10 mt-10 flex-col justify-center rounded md:w-1/2 lg:w-1/3 h-fit space-y-10 border-2">
              ...
              <div className=" mobile_flex">
                ...
                <a
                  ...
                  className="w-fit mx-auto text-white bg-[#25D366] hover:bg-[#25D366]/90 focus:ring-2 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5  focus:outline-none "
                >
