      ...
      <div className="container flex justify-center bg-[#edf8f8] ">
        <div className="my-10 w-full md:w-2/3  bg-white rounded-md shadow-xl p-8 md:p-16 flex flex-col space-y-10">
          ...
          <a
            ...
            className="w-fit mx-auto shadow-xl text-white bg-[#25D366] hover:bg-[#25D366]/90 focus:ring-1 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5  focus:outline-none"
          >
